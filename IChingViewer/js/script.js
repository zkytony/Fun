...
$(document).ready(function()
  {
    ...
    var everyFourthInFour = $(".project:nth-child(4n+4)");
    everyFourthInFour.attr("data-col", "col4");
    everyFourthInFour.appendTo("#col4");
    everyFourthInFour.removeClass("project");

    var everyThirdInFour = $(".project:nth-child(3n+3)");
    everyThirdInFour.attr("data-col", "col3");
    everyThirdInFour.appendTo("#col3");
    everyThirdInFour.removeClass("project");
    
    var everySecondInFour = $(".project:nth-child(2n+2)");
    everySecondInFour.attr("data-col", "col2");
    everySecondInFour.appendTo("#col2");
    everySecondInFour.removeClass("project");

    var everyFirstInFour = $(".project:nth-child(n+1)");
    everyFirstInFour.attr("data-col", "col1");

    everyFourthInFour.addClass("project");
    everyThirdInFour.addClass("project");
    everySecondInFour.addClass("project");
    ...
    function checkSize() {
      if ($(window).width() <= 768) {
	tinysort('div.project', {attr: 'id', order: 'desc'});
      } else {
	tinysort('div.project', {attr: 'data-col'});
      }
    }
